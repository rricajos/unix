...
- [notas/](notas/) - Apuntes sobre tecnicas de explotacion (web, sistema, red)
- [scripts/](scripts/) - Exploits personalizados y payloads
- [herramientas/](herramientas/) - Guias de herramientas (Metasploit, Burp Suite, sqlmap)
